...
package ru.koldoon.model
{
     ...
     */
    public class ExtendedSOSLoggingTarget extends AbstractTarget
    {
        ...
        public function ExtendedSOSLoggingTarget()
        {
            socket = new Socket();
            history = [];
        ...
        override public function logEvent(event:mx.logging.LogEvent):void
        {
